# 診断結果画像 — 結合済みプロンプト（全90種）

各プロンプトをそのままコピペして画像生成ツールに貼り付けてください。
生成した画像は記載のファイル名で `/public/images/results/` に配置します。

---

## 1 / 90 — sp_power_ace.webp（剛腕エース）
...
## 7 / 90 — sp_groundball.webp（グラウンドボーラー）
...
## 9 / 90 — sp_consistent.webp（安定感の権化）
...
## 16 / 90 — rp_specialist.webp（場面限定スペシャリスト）
...
## 18 / 90 — rp_workhorse.webp（連投型タフネス）
...
## 19 / 90 — rp_multi.webp（マルチイニングリリーフ）
...
## 21 / 90 — cp_finesse.webp（技巧派クローザー）
...
## 22 / 90 — cp_mental.webp（鋼のメンタルクローザー）
...
## 23 / 90 — cp_situational.webp（変則クローザー）
...
## 33 / 90 — 1b_5spot.webp（パワー5番ファースト）
...
## 36 / 90 — 1b_defensive.webp（守備堅実ファースト）
...
## 37 / 90 — 1b_9spot.webp（9番の守備固めファースト）
...
## 38 / 90 — 2b_leadoff.webp（電光石火の1番打者）
...
## 39 / 90 — 2b_connector.webp（繋ぎの二塁手）
...
## 42 / 90 — 2b_balanced.webp（バランス型セカンド）
...
## 43 / 90 — 2b_defensive.webp（守備の名手セカンド）
...
## 44 / 90 — 2b_9spot.webp（9番のつなぎ役セカンド）
...
## 47 / 90 — 3b_contact.webp（スマートヒッター3番サード）
...
## 48 / 90 — 3b_cleanup.webp（4番サードの主砲）
...
## 50 / 90 — 3b_defensive.webp（守備重視サード）
...
## 51 / 90 — 3b_so_type.webp（強肩守備のサード）
...
## 53 / 90 — ss_leadoff.webp（俊足の1番ショート）
...
## 55 / 90 — ss_allround.webp（万能型スーパーショート）
...
## 59 / 90 — ss_defensive.webp（守備の鬼ショート）
...
## 60 / 90 — ss_9spot.webp（9番の守備エキスパートショート）
...
## 61 / 90 — lf_leadoff.webp（スピードスター左翼手）
...
## 64 / 90 — lf_contact.webp（コンタクトレフト）
...
## 65 / 90 — lf_balanced.webp（バランス型レフト）
...
## 66 / 90 — lf_defensive.webp（守備型レフト）
...
## 67 / 90 — lf_9spot.webp（9番のつなぎ役レフト）
...
## 68 / 90 — cf_leadoff.webp（センターのリードオフマン）
...
## 71 / 90 — cf_allround.webp（オールラウンドセンター）
...
## 72 / 90 — cf_so_type.webp（守備の鬼センター）
...
## 73 / 90 — cf_defensive.webp（守備特化センター）
...
## 80 / 90 — rf_strong_arm.webp（強肩守備型ライト）
...
## 88 / 90 — util_super.webp（スーパーユーティリティ）
...
## 89 / 90 — util_pinch_hitter.webp（代打の切り札）
